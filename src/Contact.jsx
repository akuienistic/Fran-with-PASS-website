  ...
  return (
    <div className="contact-container container p-4 py-md-5" data-aos="fade-up">
      <div className="contact-header text-center mb-4 mb-md-5">
        <h1 className="h1-heading display-5 fw-bold display-md-4 mb-3">
          GET IN TOUCH
        </h1>
        <p
          className="contact-para display-6 mb-5 mx-auto"
          style={{ maxWidth: '600px' }}
        >
          Reach out for inquiries or clarifications by leaving your details
          below.
        </p>
      </div>
        ...
        <div className="form-container mx-auto" style={{ maxWidth: '600px' }}>
          <div className="input-wrapper mb-4 position-relative">
            ...
            <input
              type="text"
              id="fullName"
              className="inputBoxes form-control ps-5 py-3"
          ...
          <div className="btn-wrapper d-flex justify-content-center align-items-center">
            <button
              ...
              name="button"
              id="submitBtn"
              className="btn btn-primary w-40 py-3"
            >
              Submit Message
            </button>
          </div>
